...
- **De migratie controleert en vult zichzelf aan**, zodat een bestaande instance met alle stempels gevuld eindigt in plaats van halverwege omgezet.
...
- **De schakelaar tussen interne en externe tracking is weg.** `analytics.enabled` is de enige schakelaar; de tweede beloofde een onderscheid dat de data nooit droeg.
