...
```json
{
  ...
  "$id": "https://deckyard.eu/schema/v13/slide-types/quote-slide.schema.json",
...
- Per type: <!--gen:schema-url-type-->`https://deckyard.eu/schema/v13/slide-types/<type>.schema.json`<!--/gen:schema-url-type-->
- Whole deck: <!--gen:schema-url-deck-->`https://deckyard.eu/schema/v13/deck.schema.json`<!--/gen:schema-url-deck-->

**Two version numbers, do not conflate them.** The version in the `$id` is the
**content-shape** version, currently
<!--gen:schema-version-->13<!--/gen:schema-version-->. The `version` field in a
