...
Deckyard ships 36 built-in slide types: 33 offered when you add a slide,
and 3 retired ones that still render, because a deck that stops opening
...
type rather than declared on each one. They are listed here once instead of 36 times.
