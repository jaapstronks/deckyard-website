...
Deckyard ships 35 built-in slide types: 35 offered when you add a slide,
...
type rather than declared on each one. They are listed here once instead of 35 times.
