...
- Whole deck (discriminated by `type`): <!--gen:schema-url-deck-->`https://deckyard.eu/schema/v15/deck.schema.json`<!--/gen:schema-url-deck-->
...
- Slide **content** shape is versioned independently by the schema `$id`
  (`/v<N>/…`), currently version <!--gen:schema-version-->15<!--/gen:schema-version-->,
