...
- Whole deck (discriminated by `type`): <!--gen:schema-url-deck-->`https://deckyard.eu/schema/v13/deck.schema.json`<!--/gen:schema-url-deck-->
...
- Slide **content** shape is versioned independently by the schema `$id`
  (`/v<N>/…`), currently version <!--gen:schema-version-->13<!--/gen:schema-version-->,
